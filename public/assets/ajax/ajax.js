$(document).on(
    "click",
    ".app-sidebar .side-menu li a, .app-header a, .row a",
    function (e) {
        ...
        $(
            ".app-sidebar .side-menu li, .app-sidebar .side-menu li a"
        ).removeClass("active");
...
$(document).ready(function () {
    ...
    if (path == "index.blade.php") {
        call_ajax_page("index.blade.php");
    } else {
        call_ajax_page("index.blade.php");
    }
});
