...
function successToast(Response) {
    notif({
        msg:
            "<div style='text-align:left;'><b>Success!</b><br/> " +
            Response +
            "<div>",
        type: "success",
        opacity: 0.8,
...
function errorToast(Response) {
    notif({
        msg: "<div style='text-align:left;'>Error!<br/> " + Response + "<div>",
        type: "error",
        opacity: 0.8,
        multiline: true,
    });
}
function warningToast(Response) {
    notif({
        type: "warning",
        msg:
            "<div style='text-align:left;'>Warning!<br/> " + Response + "<div>",
        opacity: 0.8,
        multiline: true,
    });
}
