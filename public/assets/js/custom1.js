...
(function ($) {
    ...
    $(document).on("click", "#myonoffswitch1", function () {
        if (this.checked) {
            ...
            if (
                $("body").hasClass("bg-img1") ||
                $("body").hasClass("bg-img2") ||
                $("body").hasClass("bg-img3") ||
                $("body").hasClass("bg-img4")
            ) {
                $("body").removeClass("bg-img1");
                $("body").removeClass("bg-img2");
                $("body").removeClass("bg-img3");
...
$("#myonoffswitch24").on("click", function () {
    if (this.checked) {
        ...
        document
            ...
            .setAttribute(
                "href",
                "http://localhost/Noa/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"
            );
...
$("#myonoffswitch23").on("click", function () {
    if (this.checked) {
        ...
        document
            ...
            .setAttribute(
                "href",
                "http://localhost/Noa/assets/plugins/bootstrap/css/bootstrap.min.css"
            );
        var carousel = $(".owl-carousel");
        $.each(carousel, function (index, element) {
            // element == this
